...
const Hero = () => {
  return (
    <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto min-h-screen flex items-center">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <span className="text-primary-400 font-semibold tracking-wider uppercase">Hola, soy</span>
          <h1 className="text-5xl sm:text-7xl font-bold text-white mt-4 mb-6 leading-tight">
            Ignacio Nicolás <br />
            <span className="bg-gradient-to-r from-primary-400 to-blue-600 text-transparent bg-clip-text">
              Fernández
            </span>
          </h1>
        ...
        >
           ...
           <div className="relative bg-slate-800/50 p-2 rounded-2xl border border-slate-700/50 backdrop-blur-sm">
